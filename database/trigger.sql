...
VALUES (new.userID, new.name, new.surname, new.email, new.username, new.password, new.signupDate, new.deleteDate, new.active, new.totalMonetaryPaid, new.streetName, new.streetNumber, new.zipcode, new.cityID, 'INSERT', CURRENT_TIMESTAMP, 'TBA');
...
INSERT INTO tauditusers (userID, name, surname, email, username, password, signupDate, deleteDate, active, totalMonetaryPaid, streetName, streetNumber, zipcode, cityID, statementType, statementExecution, dbmsUser)
VALUES (old.userID, old.name, old.surname, old.email, old.username, old.password, old.signupDate, old.deleteDate, old.active, old.totalMonetaryPaid, old.streetName, old.streetNumber, old.zipcode, old.cityID, 'DELETE', CURRENT_TIMESTAMP, 'TBA');
...
INSERT INTO tauditusers (userID, name, surname, email, username, password, signupDate, deleteDate, active, totalMonetaryPaid, streetName, streetNumber, zipcode, cityID, statementType, statementExecution, dbmsUser)
VALUES (new.userID, new.name, new.surname, new.email, new.username, new.password, new.signupDate, new.deleteDate, new.active, new.totalMonetaryPaid, new.streetName, new.streetNumber, new.zipcode, new.cityID, 'UPDATE', CURRENT_TIMESTAMP, 'TBA');
...
VALUES (new.cardID, new.userID, new.ibanCode, new.expirationDate, new.ccv, new.totalAmountPaid, 'INSERT', CURRENT_TIMESTAMP, 'TBA');
...
INSERT INTO tauditcards (cardID, userID, ibanCode, expirationDate, ccv, totalAmountPaid, statementType, statementExecution, dbmsUser)
VALUES (old.cardID, old.userID, old.ibanCode, old.expirationDate, old.ccv, old.totalAmountPaid, 'DELETE', CURRENT_TIMESTAMP, 'TBA');
...
INSERT INTO tauditcards (cardID, userID, ibanCode, expirationDate, ccv, totalAmountPaid, statementType, statementExecution, dbmsUser)
VALUES (new.cardID, new.userID, new.ibanCode, new.expirationDate, new.ccv, new.totalAmountPaid, 'UPDATE', CURRENT_TIMESTAMP, 'TBA');
